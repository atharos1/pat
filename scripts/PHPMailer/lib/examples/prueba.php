...
$pac = "BARRERA, Nicolás Enrique";
$destino = array();
$destino[0]["correo"] = "nbarrera@itba.edu.ar";
$destino[0]["nombre"] = "Freis";
$destino[1]["correo"] = "holanico11@gmail.com";
$destino[1]["nombre"] = "Araujo";
$footer = '<hr />
...
<p style="margin: 0px; text-align: left;"><span style="margin: 0px; color: #000099;"><span style="font-family: Calibri; font-size: medium;">Paraguay 2302 Piso 11&ordm; Of "1" C.A.B.A.</span></span></p>
...
<p style="margin: 0px; text-align: left;"><span style="margin: 0px; color: #000099;"><span style="font-family: Calibri; font-size: medium;">TEL/FAX: (011) 4964-0379 / 4966-1224</span></span></p>
<p style="margin: 0px; text-align: left;"><span style="margin: 0px; color: #000099;"><span style="font-family: Calibri; font-size: medium;">E-mail: </span><a target="_blank"><span style="font-family: Calibri; font-size: medium;">labsantiniaraujo@laborpat.com.ar</span></a></span></p>
...
$mail->Username = "labsantiniaraujo@laborpat.com.ar";                 
$mail->Password = "huesos10";                           
//If SMTP requires TLS encryption then set it
$mail->SMTPSecure = "tls";                           
//Set TCP port to connect to 
$mail->Port = 587;                                   

$mail->From = "labsantiniaraujo@laborpat.com.ar";
$mail->FromName = "CONSULTORIO DE PATOLOGÍA OSTEOARTICULAR Y DE TEJIDOS BLANDOS";

$mail->isHTML(true);
$mail->Subject = "Informe anotomopatológico ($PacApellido, $PacNombre)";
$mail->AddAttachment($file, "Informe " . $PacApellido. ".pdf"); 

$long = count($destino);
for($i = 0; $i < $long; $i++) {
    $mail->addAddress($destino[$i]["correo"]);
    $medico = $destino[$i]["correo"];

    $mail->Body = "Dr/a $medico:<br>
        Se adjunta a este correo el informe anotomopatológico del paciente $pac. <br><br>
        Atentamente. <br>
        $footer";
    $mail->AltBody = "Dr/a $medico: 
        Se adjunta a este correo el informe anotomopatológico del paciente $pac. 
        Atentamente.";
