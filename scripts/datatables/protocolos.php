...
$columns = array(
    array( 'db' => 'protocolos.Id', 'dt' => 'ID', 'Alias' => 'Identificador' ),
    array( 'db' => "CONCAT(Medicos.Apellido, ', ', Medicos.Nombre)",     'dt' => 'Medico', 'Alias' => 'Medico' ),
    array( 'db' => "CONCAT(Pacientes.Apellido, ', ', Pacientes.Nombre, ' (', Pacientes.DNI, ')')",   'dt' => 'Paciente', 'Alias' => 'Paciente' ),
    array( 'db' => 'Partes.Nombre',     'dt' => 'Localizacion', 'Alias' => 'Localizacion' ),
    array( 'db' => 'Hospitales.Nombre',     'dt' => 'Hospital', 'Alias' => 'Hospital' ),
    array(
